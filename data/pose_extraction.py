# 이 파일은 동영상을 입력받아 프레임을 추출하고, 프레임별 skeleton keypoint를 추출하는 코드입니다.
# 이 파일은 data/generte_anno.py에서 사용됩니다.
# 사용법 : python data/pose_extraction.py [동영상 파일 경로] [출력 파일 이름.pkl]
import abc
import argparse
...
args.det_checkpoint = 'data/checkpoints/faster_rcnn_r50_fpn_1x_coco-person_20201216_175929-d022e227.pth'  # noqa: E501
args.det_score_thr = 0.5
args.pose_config = 'demo/demo_configs/td-hm_hrnet-w32_8xb64-210e_coco-256x192_infer.py'  # noqa: E501
args.pose_checkpoint = 'data/checkpoints/hrnet_w32_coco_256x192-c78dce93_20200708.pth'  # noqa: E501
...
def pose_extraction(vid, skip_postproc=False):
...
if __name__ == '__main__':
    ...
    try:
        anno = pose_extraction(args.video, args.skip_postproc)
